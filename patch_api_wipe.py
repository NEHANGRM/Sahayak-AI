...
if wipe_endpoint not in content:
    content = content.replace("app = FastAPI(title=\"Sahayak AI - Civic Grievance Backend\", version=\"1.0.0\")", "app = FastAPI(title=\"Sahayak AI - Civic Grievance Backend\", version=\"1.0.0\")\n" + wipe_endpoint)
